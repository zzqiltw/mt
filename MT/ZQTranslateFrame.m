...
- (void)countFrameWithModel:(ZQTranslateModel *)model
{
    ...
    CGSize srcLabelsize = [model.srcText sizeWithFont:TextFont constrainedToSize:CGSizeMake(240, 200)];
    ...
    CGSize labelsize = [model.text sizeWithFont:TextFont constrainedToSize:CGSizeMake(240, 200)];
    _textFrame = CGRectMake(_srcTextFrame.origin.x, CGRectGetMaxY(_srcTextFrame) + Margin * 1, labelsize.width, labelsize.height);
